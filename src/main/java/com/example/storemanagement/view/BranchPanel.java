...
public class BranchPanel extends JPanel {
    ...
    public BranchPanel() {
        ...
        btnAdd.addActionListener(e -> {
            controller.addBranch(txtName.getText(), txtAddress.getText(), txtPhone.getText());
            loadData();
            clear();
        });
        ...
        btnUpdate.addActionListener(e -> {
            ...
            controller.updateBranch(Integer.parseInt(txtId.getText()), txtName.getText(),
    ...
    private void loadData() {
        ...
        for (Branch b : list) {
            model.addRow(new Object[]{stt++, b.getBranchID(), b.getBranchName(), b.getAddress(), b.getPhone()});
        }
    }
